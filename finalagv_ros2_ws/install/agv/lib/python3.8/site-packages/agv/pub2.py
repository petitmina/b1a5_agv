...
class VideoProcessingThread(Thread):
    def __init__(self, width):
        ...
        self.vid.set(cv2.CAP_PROP_FPS, 90)
    ...
    def run(self):
        ...
        while udp_run:
            ...
            if ret:
                ...
                # 노란색 감지
                lower_yellow = np.array([20, 100, 100])  # HSV 노란색 최소값
                upper_yellow = np.array([30, 255, 255])  # HSV 노란색 최대값
                ...
                for obj in decoded_objects:
                    ...
                    #     motor_running = True 
                    cv2.rectangle(new_frame, (obj.rect.left, obj.rect.top), (obj.rect.left + obj.rect.width, obj.rect.top + obj.rect.height), (0, 255, 0), 2)
