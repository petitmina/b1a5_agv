...
bool agv_interfaces__srv__color__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agv_interfaces.srv._color.Color_Request", full_classname_dest, 39) == 0);
  }
  agv_interfaces__srv__Color_Request * ros_message = _ros_message;
  {  // red
...
PyObject * agv_interfaces__srv__color__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("agv_interfaces.srv._color");
...
ROSIDL_GENERATOR_C_EXPORT
bool agv_interfaces__srv__color__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agv_interfaces.srv._color.Color_Response", full_classname_dest, 40) == 0);
  }
  agv_interfaces__srv__Color_Response * ros_message = _ros_message;
