...
#include <stddef.h>
#include "agv_interfaces/srv/detail/reset_odom__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  agv_interfaces__srv__ResetOdom_Request__init(message_memory);
}

void ResetOdom_Request__rosidl_typesupport_introspection_c__ResetOdom_Request_fini_function(void * message_memory)
{
  agv_interfaces__srv__ResetOdom_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ResetOdom_Request__rosidl_typesupport_introspection_c__ResetOdom_Request_message_member_array[3] = {
  {
    ...
    offsetof(agv_interfaces__srv__ResetOdom_Request, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(agv_interfaces__srv__ResetOdom_Request, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(agv_interfaces__srv__ResetOdom_Request, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ResetOdom_Request__rosidl_typesupport_introspection_c__ResetOdom_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(agv_interfaces__srv__ResetOdom_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, ResetOdom_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  agv_interfaces__srv__ResetOdom_Response__init(message_memory);
}

void ResetOdom_Response__rosidl_typesupport_introspection_c__ResetOdom_Response_fini_function(void * message_memory)
{
  agv_interfaces__srv__ResetOdom_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ResetOdom_Response__rosidl_typesupport_introspection_c__ResetOdom_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(agv_interfaces__srv__ResetOdom_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ResetOdom_Response__rosidl_typesupport_introspection_c__ResetOdom_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(agv_interfaces__srv__ResetOdom_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_agv_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, ResetOdom_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_service_members = {
  "agv_interfaces__srv",  // service namespace
  "ResetOdom",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_Request_message_type_support_handle,
  NULL  // response message
  // agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_Response_message_type_support_handle
};

static rosidl_service_type_support_t agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_service_type_support_handle = {
  0,
  &agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, ResetOdom)() {
  if (!agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_service_type_support_handle.typesupport_identifier) {
    agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, ResetOdom_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, ResetOdom_Response)()->data;
  }

  return &agv_interfaces__srv__detail__reset_odom__rosidl_typesupport_introspection_c__ResetOdom_service_type_support_handle;
}
