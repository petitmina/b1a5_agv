...
from agv_interfaces.srv import Battery
from agv_interfaces.srv import Color
from agv_interfaces.srv import SaveColor
from agv_interfaces.srv import ResetOdom
from agv_interfaces.srv import Onoff
from agv_interfaces.srv import Calg
...
class OMOR1MiniNode(Node):
  def __init__(self):
    super().__init__('agv_motor_setting')
