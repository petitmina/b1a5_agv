...
class Metaclass_Onoff(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from agv_interfaces.srv import _onoff
...
class Onoff(metaclass=Metaclass_Onoff):
    from agv_interfaces.srv._onoff import Onoff_Request as Request
    from agv_interfaces.srv._onoff import Onoff_Response as Response
