...
class Metaclass_SaveColor(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from agv_interfaces.srv import _save_color
...
class SaveColor(metaclass=Metaclass_SaveColor):
    from agv_interfaces.srv._save_color import SaveColor_Request as Request
    from agv_interfaces.srv._save_color import SaveColor_Response as Response
