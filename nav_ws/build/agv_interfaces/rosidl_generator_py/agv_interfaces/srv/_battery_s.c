...
bool agv_interfaces__srv__battery__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agv_interfaces.srv._battery.Battery_Request", full_classname_dest, 43) == 0);
  }
  agv_interfaces__srv__Battery_Request * ros_message = _ros_message;
...
PyObject * agv_interfaces__srv__battery__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("agv_interfaces.srv._battery");
...
ROSIDL_GENERATOR_C_EXPORT
bool agv_interfaces__srv__battery__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agv_interfaces.srv._battery.Battery_Response", full_classname_dest, 44) == 0);
  }
  agv_interfaces__srv__Battery_Response * ros_message = _ros_message;
  {  // volt
