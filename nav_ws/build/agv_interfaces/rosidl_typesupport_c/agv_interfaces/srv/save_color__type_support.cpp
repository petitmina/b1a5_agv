...
#include "agv_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _SaveColor_Request_type_support_symbol_names_t _SaveColor_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, SaveColor_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, SaveColor_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_agv_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agv_interfaces, srv, SaveColor_Request)() {
  return &::agv_interfaces::srv::rosidl_typesupport_c::SaveColor_Request_message_type_support_handle;
}
...
static const _SaveColor_Response_type_support_symbol_names_t _SaveColor_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, SaveColor_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, SaveColor_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_agv_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agv_interfaces, srv, SaveColor_Response)() {
  return &::agv_interfaces::srv::rosidl_typesupport_c::SaveColor_Response_message_type_support_handle;
}
...
static const _SaveColor_type_support_symbol_names_t _SaveColor_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, SaveColor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, SaveColor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, agv_interfaces, srv, SaveColor)() {
  return &::agv_interfaces::srv::rosidl_typesupport_c::SaveColor_service_type_support_handle;
}
