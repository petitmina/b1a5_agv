...
static const _Battery_Request_type_support_symbol_names_t _Battery_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Battery_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, Battery_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agv_interfaces, srv, Battery_Request)() {
  return &::agv_interfaces::srv::rosidl_typesupport_c::Battery_Request_message_type_support_handle;
}
...
static const _Battery_Response_type_support_symbol_names_t _Battery_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Battery_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, Battery_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_agv_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, agv_interfaces, srv, Battery_Response)() {
  return &::agv_interfaces::srv::rosidl_typesupport_c::Battery_Response_message_type_support_handle;
}
...
static const _Battery_type_support_symbol_names_t _Battery_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Battery)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, agv_interfaces, srv, Battery)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, agv_interfaces, srv, Battery)() {
  return &::agv_interfaces::srv::rosidl_typesupport_c::Battery_service_type_support_handle;
}
