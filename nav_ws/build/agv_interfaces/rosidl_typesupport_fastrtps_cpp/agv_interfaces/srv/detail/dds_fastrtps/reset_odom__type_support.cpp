...
#include "agv_interfaces/srv/detail/reset_odom__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agv_interfaces::srv::ResetOdom_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_interfaces::srv::ResetOdom_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const agv_interfaces::srv::ResetOdom_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agv_interfaces::srv::ResetOdom_Request *>(
    untyped_ros_message);
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_ResetOdom_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, ResetOdom_Request)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_ResetOdom_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_agv_interfaces
cdr_serialize(
  const agv_interfaces::srv::ResetOdom_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_interfaces::srv::ResetOdom_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const agv_interfaces::srv::ResetOdom_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<agv_interfaces::srv::ResetOdom_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_ResetOdom_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, ResetOdom_Response)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_ResetOdom_Response__handle;
}
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_ResetOdom__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, ResetOdom)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_ResetOdom__handle;
}
