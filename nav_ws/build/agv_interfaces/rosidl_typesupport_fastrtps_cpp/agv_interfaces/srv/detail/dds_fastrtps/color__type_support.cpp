...
#include "agv_interfaces/srv/detail/color__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agv_interfaces::srv::Color_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_interfaces::srv::Color_Request & ros_message)
{
  // Member: red
  cdr >> ros_message.red;
...
{
  auto typed_message =
    static_cast<const agv_interfaces::srv::Color_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agv_interfaces::srv::Color_Request *>(
    untyped_ros_message);
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Color_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, Color_Request)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Color_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_agv_interfaces
cdr_serialize(
  const agv_interfaces::srv::Color_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_interfaces::srv::Color_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const agv_interfaces::srv::Color_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<agv_interfaces::srv::Color_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Color_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, Color_Response)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Color_Response__handle;
}
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Color__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, Color)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Color__handle;
}
