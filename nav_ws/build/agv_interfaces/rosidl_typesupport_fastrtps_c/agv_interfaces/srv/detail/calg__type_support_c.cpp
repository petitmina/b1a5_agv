...
#include "agv_interfaces/srv/detail/calg__rosidl_typesupport_fastrtps_c.h"
...
using _Calg_Request__ros_msg_type = agv_interfaces__srv__Calg_Request;
...
size_t get_serialized_size_agv_interfaces__srv__Calg_Request(
  const void * untyped_ros_message,
...
static uint32_t _Calg_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agv_interfaces__srv__Calg_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_interfaces
size_t max_serialized_size_agv_interfaces__srv__Calg_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_agv_interfaces__srv__Calg_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Calg_Request)() {
...
using _Calg_Response__ros_msg_type = agv_interfaces__srv__Calg_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_interfaces
size_t get_serialized_size_agv_interfaces__srv__Calg_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Calg_Response__ros_msg_type * ros_message = static_cast<const _Calg_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agv_interfaces__srv__Calg_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_interfaces
size_t max_serialized_size_agv_interfaces__srv__Calg_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_agv_interfaces__srv__Calg_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Calg_Response)() {
...
// already included above
// #include "agv_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "agv_interfaces/srv/calg.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Calg)() {
  return &Calg__handle;
}
