...
#include "agv_interfaces/srv/detail/color__rosidl_typesupport_fastrtps_c.h"
...
using _Color_Request__ros_msg_type = agv_interfaces__srv__Color_Request;
...
size_t get_serialized_size_agv_interfaces__srv__Color_Request(
  const void * untyped_ros_message,
...
static uint32_t _Color_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agv_interfaces__srv__Color_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_interfaces
size_t max_serialized_size_agv_interfaces__srv__Color_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_agv_interfaces__srv__Color_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Color_Request)() {
...
using _Color_Response__ros_msg_type = agv_interfaces__srv__Color_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_interfaces
size_t get_serialized_size_agv_interfaces__srv__Color_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Color_Response__ros_msg_type * ros_message = static_cast<const _Color_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agv_interfaces__srv__Color_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_interfaces
size_t max_serialized_size_agv_interfaces__srv__Color_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_agv_interfaces__srv__Color_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Color_Response)() {
...
// already included above
// #include "agv_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "agv_interfaces/srv/color.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_interfaces, srv, Color)() {
